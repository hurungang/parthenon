...
from app.core.resource_types import ResourceTypeManifest, RT_SYSTEM_PERMISSIONS
...
class TestListResourceTypes:
    ...
    async def test_returns_all_resource_types_and_actions(self):
        ...
        app.dependency_overrides[require_permission(RT_SYSTEM_PERMISSIONS, "read")] = _allow_override()
    ...
    async def test_requires_role_read_permission(self):
        ...
        _, db_dep = _make_mock_db()
        app.dependency_overrides[get_db] = db_dep
        app.dependency_overrides[require_permission(RT_SYSTEM_PERMISSIONS, "read")] = _deny_override()
...
class TestUpdatePolicyStatement:
    ...
    async def test_update_policy_statement(self, test_engine):
        ...
        app.dependency_overrides[get_db] = get_test_db
        app.dependency_overrides[require_permission(RT_SYSTEM_PERMISSIONS, "manage")] = _allow_override()
        app.dependency_overrides[require_permission(RT_SYSTEM_PERMISSIONS, "read")] = _allow_override()
